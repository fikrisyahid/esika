...
export default function ModalAddQuestionCreate({
  open,
  onClose,
  questions,
  setQuestions,
  ...
  const handleAddQuestion = () => {
    ...
    // generate unique ID that differs from other questions
    let id = generateCode();
    const idExists = questions.find((question) => question?.id === id);
    while (idExists) {
      id = generateCode();
    }
    setQuestions((old) => [...old, { id, ...localQuestion }]);
    handleOnCloseLocal();
  };
